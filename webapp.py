...
def render_responseeuro():
    ...
    reply = euro*.85   
    return render_template('responseeuro.html', responseeuro = str(reply))
...
def render_responsesol():
    ...
    reply = sol*3.26
    return render_template('responsesol.html', responsesol = str(reply))
...
def render_responsefranc():
    ...
    reply = franc*.97
    return render_template('responsefranc.html', responsefranc = str(reply))
