...
def render_responseeuro():
    ...
    reply = euro*.85   
    return render_template('responseeuro.html',euro, responseeuro = str(reply))
...
def render_responsesol():
    ...
    reply = sol*3.26
    return render_template('responsesol.html',sol, responsesol = str(reply))
...
def render_responsefranc():
    ...
    reply = franc*.97
    return render_template('responsefranc.html',franc, responsefranc = str(reply))
